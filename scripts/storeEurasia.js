    ...
    rivers: [
        {
            title: "Амур",
            images: [
                "./img/rives of evrasia/Reka-Amur.jpg"
            ],
            texts: [
                "Амур — река на Дальнем Востоке в Восточной Азии. Протекает по территории России и границе России и КНР. Длина — 2824 км (от слияния Шилки и Аргуни). Впадает в Охотское море или Японское море. Годовой сток составляет 403,66 км³.",
        ...
        },
        {
            title: "Брахмапутра",
            images: [
                "./img/rives of evrasia/Brahmaputra.jpg",
                "./img/rives of evrasia/Брахмапутра.jpg",
                "./img/rives of evrasia/Брахмапутра2.jpg",
            ],
            texts: [
        ...
        },
        {
            title: "Вента",
            images: [
                "./img/rives of evrasia/Вента.jpg",
                "./img/rives of evrasia/Venta.jpg",
                "./img/rives of evrasia/Вента2.jpg",
            ],
            texts: [
        ...
        },
        {
            title: "Висла",
            images: [
                "./img/rives of evrasia/Висла1.jpg",
                "./img/rives of evrasia/Висла2.jpg",
                "./img/rives of evrasia/Висла3.jpg"
            ],
            texts: [
                "Висла — наиболее важная и протяжённая река Польши (протекает через всю страну с юга на север), а также наиболее длинная и вторая по водности (после Невы) река бассейна Балтийского моря.",
                "Длина Вислы составляет 1068 км, площадь водосборного бассейна — 198,5 тыс. км².",
                ...
                "Большинство главных притоков впадают справа: Дунаец, Вислока, Сан, Вепш, Западный Буг, Нарев; из левых наиболее крупные — Пилица и Брда."
            ]
        }
    ]
};
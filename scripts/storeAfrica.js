    ...
    rivers: [
        {
            title: "Замбези",
            images: [
                "./img/rivers africa/zambezi1.jpg",
                "./img/rivers africa/zambezi2.jpg"
            ],
            texts: [
                "Замбе́зи — четвёртая по протяжённости река в Африке.",
                "Протяжённость реки — 2660 км, площадь бассейна — 1 330 000 км². Средний расход воды вблизи устья реки 16 000 м³/с; годовой сток 106 км³.",
                ...
                "Водопады: Чавума на границе Замбии и Анголы и Нгамбве в Западной Замбии. На всём протяжении реки построены только пять мостов: в городах Чинвинги, Катима-Мулило, Виктория-Фолс (Мост водопада Виктория), Чирунду и Тете.",
        ...
        },
        {
            title: "Оранжевая",
            images: [
                "./img/rivers africa/orange1.jpg",
                "./img/rivers africa/orange2.jpg",
                "./img/rivers africa/orange3.jpg",
            ],
            texts: [
                "Ора́нжевая (англ. Orange River; африк. Oranjerivier, Ораньерифир) — река в южной Африке, седьмая по протяжённости на континенте. Берёт начало в Драконовых горах в Лесото, протекает в основном в ЮАР, в низовьях образует границу с Намибией, впадает в Атлантический океан. Длина реки по разным данным от 2100 до 2250 км. Площадь водосборного бассейна — 973 000 км² (по другим данным — 855 000 км²). Крупнейший приток — река Вааль.",
        ...
        },
        {
            title: "Лимпопо",
            images: [
                "./img/rivers africa/limpopo1.jpg",
            ],
            texts: [
                "Лимпо́по (в верхнем течении Кро́кодайл) — река в Южной Африке на территории ЮАР, Ботсваны, Зимбабве и Мозамбика.",
                ...
                "Образуется при слиянии рек Марико и Крокодайл.",
                "На реке имеется несколько порогов, она течёт зигзагами и служит природной границей между несколькими странами. Крупнейшим правым притоком Лимпопо является Улифантс. К северо-востоку от реки находится национальный парк Крюгера.",
